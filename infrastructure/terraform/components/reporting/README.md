...
| <a name="input_is_primary_environment"></a> [is\_primary\_environment](#input\_is\_primary\_environment) | Is this the primary environment for the project? Used to determine if certain resources should be created. | `bool` | `false` | no |
